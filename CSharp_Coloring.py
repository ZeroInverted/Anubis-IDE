...
class CSharpHighlighter(QSyntaxHighlighter):
    ...
    keywords = [
        ...
        'void', 'volatile','while', 'namespace',
        'new', 'null', 'object', 'operator',
        'out', 'override', 'params', 'private',
        'protected','public','readonly','ref',
        'return','sbyte','sealed','short',
        'sizeof','stackalloc', 'event', 'explicit',
        'extern','false','finally','fixed',
        'float','for','foreach','goto',
        'if','implicit','in','int',
        'interface','internal', 'is','lock',
        'long','abstract','as','base',
        'bool','break','byte','case',
        'catch','char','checked', 'class',
        'const','continue','decimal','default',
        'delegate','do','double','else',
        'enum','set','unmanaged','value',
        'var','when','where','with',
        'yield','notnull','nuint','on',
        'or','orderby','partial','record',
        'remove','select','get','global',
        'group','init','into','join',
        'let','managed','calling','nameof',
        'nint','not','add','and',
        'alias','ascending','async','await',
